	...
	<section class="relative mb-5 overflow-hidden rounded-[1.75rem] border border-white/70 bg-white/75 p-4 shadow-2xl shadow-lavender/10 backdrop-blur-xl sm:p-5 lg:p-6">
		...
		<div class="relative flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
			<div class="flex gap-4">
				<button onclick={() => goto('/admin/series')} class="mt-1 hidden h-10 w-10 items-center justify-center rounded-2xl bg-white/70 text-plum shadow-sm ring-1 ring-lavender/20 transition hover:-translate-x-0.5 hover:bg-white sm:flex" aria-label="กลับ">
				...
				<div class="min-w-0 pt-1 sm:pt-2">
					<button onclick={() => goto('/admin/series')} class="mb-2 inline-flex items-center gap-1 rounded-full bg-white/65 px-2.5 py-1 text-xs font-medium text-plum-light ring-1 ring-lavender/20 sm:hidden">
