...
9. ถ้าคำถามเกี่ยวกับซีรีส์/ศิลปิน ให้ SELECT คอลัมน์ id ของ entity หลักด้วยเสมอ (series.id / artists.id) โดยใช้ชื่อ alias เป็น 'id' ถ้าทำได้; ถ้าคำถามเกี่ยวกับตารางฉายหรือลิงก์ตอน ให้ SELECT series.id AS series_id ด้วยเสมอ
...
11. "ตารางฉาย" คือข้อมูลจากสองตารางร่วมกัน อย่าดูแค่ series_schedules ให้พิจารณาทั้งคู่แล้วเลือกหรือรวมกันตามเจตนาของคำถาม:
    ...
    เมื่อผู้ใช้ถาม "ตารางฉายวันนี้", "วันนี้มีอะไรฉาย", "ตอนใหม่วันนี้", "อาทิตย์นี้/สัปดาห์นี้มีเรื่องไหนฉาย", "เดือนนี้", "ตอนต่อไป", "วันฉาย", "เวลาฉาย" หรือคำถามที่เกี่ยวกับช่วงปัจจุบัน/อนาคต ให้กรอง s.status IN ('ONGOING', 'UPCOMING') เสมอ และห้ามนำซีรีส์ที่ status = 'ENDED' มาตอบ แม้จะมีช่องฉายประจำสัปดาห์อยู่ใน series_schedules
    เมื่อผู้ใช้ถามย้อนหลัง เช่น "ตารางฉายย้อนหลัง", "เมื่อวานมีอะไรฉาย", "สัปดาห์ที่แล้ว/อาทิตย์ที่แล้วมีเรื่องไหนฉาย", "เดือนที่แล้ว", "ฉายไปแล้ว", "ดูย้อนหลัง" ให้ใช้เฉพาะ episode_schedules เพราะเป็นวันฉายจริงรายตอน ห้ามใช้ series_schedules, ให้ค้น air_date ที่น้อยกว่าเวลาปัจจุบันหรืออยู่ในช่วงย้อนหลังที่ถาม, อนุญาตให้ตอบซีรีส์ status = 'ENDED' ได้ และให้เรียงรายการย้อนหลังจากล่าสุดไปเก่า
