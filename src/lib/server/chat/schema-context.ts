...
11. "ตารางฉาย" คือข้อมูลจากสองตารางร่วมกัน อย่าดูแค่ series_schedules ให้พิจารณาทั้งคู่แล้วเลือกหรือรวมกันตามเจตนาของคำถาม:
    ...
    เมื่อผู้ใช้ถาม "ตารางฉายวันนี้", "วันนี้มีอะไรฉาย", "ตอนใหม่วันนี้" หรือคำถามที่หมายถึงวันนี้/ตอนใหม่จริง ให้กรอง s.status = 'ONGOING' เสมอ และห้ามนำซีรีส์ที่ status = 'ENDED' มาตอบ แม้จะมีช่องฉายประจำสัปดาห์อยู่ใน series_schedules
