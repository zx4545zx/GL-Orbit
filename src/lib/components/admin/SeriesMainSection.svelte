...
<div class="space-y-6">
	...
	<section class="overflow-hidden rounded-3xl border border-lavender/20 bg-white/55 shadow-lg shadow-lavender/5">
		...
		<div class="space-y-6 p-4 sm:p-6">
			<div class="grid gap-4 sm:grid-cols-2"><div class="rounded-2xl border border-lavender/15 bg-white/60 p-3"><ImageUpload bind:url={posterUrl} type="posters" purpose="poster" label="โปสเตอร์" /></div><div class="rounded-2xl border border-lavender/15 bg-white/60 p-3"><ImageUpload bind:url={coverUrl} type="posters" purpose="cover" label="ภาพปกแนวนอน" /></div></div>
